    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <img src="{{ url('/images/uploads/avatars', Auth::Guard('admin')->user()->avatar)  }}" class="img-circle" alt="User Image">
        </div>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="pages/layout/top-nav.html"><i class="fa fa-circle-o"></i> Students</a></li>
            <li><a href="pages/layout/boxed.html"><i class="fa fa-circle-o"></i> Faculty</a></li>
            <li><a href="pages/layout/fixed.html"><i class="fa fa-circle-o"></i> General</a></li>
          </ul>
        </li>
        <li>
          <a href="pages/widgets.html">
            <i class="fa fa-th"></i> <span>Courses Offered</span>
            <span class="pull-right-container">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="#"><i class="fas fa-circle-o"></i> CS</a></li>
                <li><a href="#"><i class="fas fa-circle-o"></i> IT</a></li>
                <li><a href="#"><i class="fas fa-circle-o"></i> CE</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="pages/tables/simple.html"><i class="fa fa-circle-o"></i> CS</a></li>
            <li><a href="pages/tables/data.html"><i class="fa fa-circle-o"></i> IT</a></li>
            <li><a href="#"><i class="fa fa-circle-o"></i> CE</a></li>
          </ul>
        </li>
        <li>
